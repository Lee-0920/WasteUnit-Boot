...
#define USARTx_CLK_CONFIG              RCC_APB1PeriphClockCmd(RCC_APB1Periph_UART7, ENABLE)
#define USARTx_RX_CONFIG               RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOE, ENABLE)
#define USARTx_TX_CONFIG               RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOE, ENABLE)
#define USARTx                         UART7
#define USARTx_GPIO_AF                 GPIO_AF_UART7
#define USARTx_TX_PIN                  GPIO_Pin_8
#define USARTx_TX_PinSource            GPIO_PinSource8
