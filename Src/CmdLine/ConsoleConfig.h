 ...
 * @file
 * @brief 命令行程序配置。
 * @details 为用户提供编译配置的宏接口，以定义本命令行程序的提示符和其它功能特性。
 * @version 1.0.0
 ...
 */
#define CONSOLE_PROMPT_STRING               "<UP> "
 ...
 * @brief 定义欢迎信息中的产品信息。
 */
#define CONSOLE_WELCOME_PRODUCT             "STM32F4 Bootloader"

/**
 * @brief 定义欢迎信息中的版权信息。
 * @details 如不需要，请注释该宏。
 */
#define CONSOLE_WELCOME_COPYRIGHT           "Copyright(C) LABSUN 2016-2017"

/**
 * @brief 定义欢迎信息中的其它信息。
 * @details 如不需要，请注释该宏。
 */
#define CONSOLE_WELCOME_OTHER               "Console for STM32F4 port"
 ...
 * @note 最大只支持256条历史命令
 */
#define CONSOLE_CMD_HISTORY_NUM             5
